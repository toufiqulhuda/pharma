			...
			<div class="span10">
				<div class="contentheader">
					...
					<div style="margin-top: -19px; margin-bottom: 21px;">
						<a href="index.php"><button class="btn btn-default btn-large" style="float: right;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
					</div>
				</div>
				<ul class="breadcrumb">
					<a href="index.php">
					...
					<tbody>
						...
						?>
							<tr class="record">
								...
								<td width="90"><a href="delete.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty']; ?>&code=<?php echo $row['product']; ?>"><button class="btn btn-mini btn-danger"><i class="icon icon-remove icon-2x"></i> </button></a></td>
							</tr>
						<?php
						}
						?>
