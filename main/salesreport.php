		...
		<?php include('sidebarNav.php');?>	
			...
			<div class="span10">
				...
				<form action="salesreport.php" method="get">
					<center><strong>From : <input onkeydown="return false;" type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" value="" /> To: <input onkeydown="return false;" type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="" />
