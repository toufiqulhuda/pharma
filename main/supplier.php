	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<a rel="facebox" href="supplier/addsupplier.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Supplier</button></a><br><br>
					...
					<tbody>
						...
						?>
							<tr class="record">
								...
								<td><a rel="facebox" href="supplier/editsupplier.php?id=<?php echo $row['suplier_id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a>
